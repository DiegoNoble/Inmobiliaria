...
import com.dnsoft.inmobiliaria.models.DestinoAlquilerTableModel;
 ...
 * @author Diego Noble
 */
public class CRUDDestinoAlquiler extends javax.swing.JDialog {

    IDestinoAlquilerDAO destinosDAO;
    Container container;
    DestinoAlquiler destino;
    List<DestinoAlquiler> listDestinoAlquilers;
    DestinoAlquilerTableModel tableModel;
    ListSelectionModel listModel;
    ContratosController contratosController;

    public CRUDDestinoAlquiler(java.awt.Frame parent, boolean modal, Component frame, ContratosController contratosController) {
        super(parent, modal);
        initComponents();
        ...
        destinosDAO = container.getBean(IDestinoAlquilerDAO.class);
    ...
    void configuraTbl() {
        ...
        listDestinoAlquilers = new ArrayList<DestinoAlquiler>();
        listDestinoAlquilers.addAll(destinosDAO.findAll());

        tableModel = new DestinoAlquilerTableModel(listDestinoAlquilers);
    ...
    void agregarNuevo() {
        destino = new DestinoAlquiler();
        tableModel.agregar(destino);
    }

    void elminarSeleccionado() {
        try {
            DestinoAlquiler toDelete = tableModel.getCliente(tbl.getSelectedRow());
            tableModel.eliminar(tbl.getSelectedRow());
            destinosDAO.delete(toDelete);
            btnEliminar.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Registro de Destino alquiler");
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        int index = listDestinoAlquilers.indexOf(destino);
    ...
    private void txtBuscaPropiedadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBuscaPropiedadActionPerformed
        ...
        listDestinoAlquilers.clear();
        listDestinoAlquilers.addAll(destinosDAO.findDestinoAlquiler(txtBuscaPropiedad.getText()));
