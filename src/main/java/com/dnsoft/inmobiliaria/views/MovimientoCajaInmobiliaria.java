 ...
 * @author Diego Noble
 */
public class MovimientoCajaInmobiliaria extends javax.swing.JDialog {
    ...
    public MovimientoCajaInmobiliaria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public MovimientoCajaInmobiliaria(java.awt.Frame parent, boolean modal, Rubro rubroSeleccionado, TipoMovimiento tipoMovimiento, ControlDeCajaController cajaController, TipoDeCaja tipoDeCaja) {
        super(parent, modal);
        initComponents();
    ...
    void movimientoCaja() {
        ...
        try {
            ...
            new ImprimeRecibo(movimientoCaja, " ", movimientoCaja.getDescripcion(), "","").imprimieReciboEntrada();
            //new ImprimeReciboMovCaja(movimientoCaja, , null)
        } catch (Exception e) {
