...
import com.dnsoft.inmobiliaria.models.LugarFormadePagoTableModel;
 ...
 * @author Diego Noble
 */
public class DetalleLugarFormadePago extends javax.swing.JDialog {

    ILugarFormadePagoDAO bancosDAO;
    Container container;
    LugarFormadePago banco;
    List<LugarFormadePago> listLugarFormadePagos;
    LugarFormadePagoTableModel tableModel;
    ListSelectionModel listModel;

    public DetalleLugarFormadePago(java.awt.Frame parent, boolean modal, Component frame) {
        super(parent, modal);
        initComponents();
        ...
        bancosDAO = container.getBean(ILugarFormadePagoDAO.class);
    ...
    void configuraTbl() {
        ...
        listLugarFormadePagos = new ArrayList<LugarFormadePago>();
        listLugarFormadePagos.addAll(bancosDAO.findAll());

        tableModel = new LugarFormadePagoTableModel(listLugarFormadePagos);
    ...
    void agregarNuevo() {
        banco = new LugarFormadePago();
        tableModel.agregar(banco);
    }

    void elminarSeleccionado() {
        try {
            LugarFormadePago toDelete = tableModel.getCliente(tbl.getSelectedRow());
            tableModel.eliminar(tbl.getSelectedRow());
            bancosDAO.delete(toDelete);
            btnEliminar.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Registro de Forma de Pago");
    ...
    private void txtBuscaPropiedadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBuscaPropiedadActionPerformed
        ...
        listLugarFormadePagos.clear();
        listLugarFormadePagos.addAll(bancosDAO.findLugarFormadePago(txtBuscaPropiedad.getText()));
