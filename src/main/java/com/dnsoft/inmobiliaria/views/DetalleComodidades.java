...
public class DetalleComodidades extends javax.swing.JDialog {
    ...
    Container container;
    Comodidad comodidad;
    List<Comodidad> listComodidades;
    ...
    void elminarSeleccionado() {
        try {
            Comodidad toDelete = tableModel.getCliente(tbl.getSelectedRow());
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Registro de comodidades");
    ...
    private void txtBuscaPropiedadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBuscaPropiedadActionPerformed
        ...
        listComodidades.addAll(comodidadesDAO.findComodidad(txtBuscaPropiedad.getText()));
