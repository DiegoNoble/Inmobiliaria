...
public class ConsultaDeCajaView extends InternalFrameEstandar {

    public ConsultaDeCajaView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jPanel1.add(dpInicio, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jPanel1.add(dpFin, gridBagConstraints);
        ...
        jLabel4.setText("Consultas de Caja"); // NOI18N
