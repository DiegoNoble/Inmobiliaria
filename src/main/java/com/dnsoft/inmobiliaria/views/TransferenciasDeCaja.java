 ...
 * @author Diego Noble
 */
public class TransferenciasDeCaja extends javax.swing.JDialog {
    ...
    public TransferenciasDeCaja(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public TransferenciasDeCaja(java.awt.Frame parent, boolean modal, Rubro rubroSeleccionado, TipoMovimiento tipoMovimiento, ControlDeCajaController cajaController, TipoDeCaja tipoDeCaja) {
        super(parent, modal);
        initComponents();
        ...
        inicio();
        if (tipoDeCaja != null) {
            cbTipoDeCajaOrigen.setSelectedItem(tipoDeCaja);
        }
    ...
    void movimientoCaja() {
        ...
        try {
            ...
            if (cbTipoDeCajaDestino.getSelectedItem() != "Cuenta de tercero") {

                Caja movimientoSalida = new Caja();
                movimientoSalida.setDescripcion(txtDetalle.getText());
                movimientoSalida.setEntrada(BigDecimal.ZERO);
                movimientoSalida.setFecha(new Date());
                movimientoSalida.setMoneda(monedaSeleccionada);
                movimientoSalida.setRubro(rubroSeleccionado);
                movimientoSalida.setSaldo(calculaSaldo().subtract(valor));
                movimientoSalida.setSalida(valor);
                movimientoSalida.setTipoDeCaja((TipoDeCaja) cbTipoDeCajaOrigen.getSelectedItem());
                cajaDAO.save(movimientoSalida);
                ...
                movimientoCaja.setTipoDeCaja((TipoDeCaja) cbTipoDeCajaDestino.getSelectedItem());
                ...
                movimientoCaja.setTipoDeCaja((TipoDeCaja) cbTipoDeCajaOrigen.getSelectedItem());
                cajaDAO.save(movimientoCaja);
            }
            JOptionPane.showMessageDialog(this, "Movimiento registrado correctamente", "Correcto", JOptionPane.INFORMATION_MESSAGE);
            //new ImprimeReciboMovCaja(movimientoCaja, propietario.toString(), movimientoCaja.getDescripcion()).imprimieReciboSalida();
        } catch (Exception e) {
    ...
    BigDecimal calculaSaldo() {
        ...
        Caja ultimoMovimiento = cajaDAO.findUltimoMovimiento((Moneda) cbMoneda.getSelectedItem(), (TipoDeCaja) cbTipoDeCajaOrigen.getSelectedItem());
    ...
    private void cargaTiposDeCaja() {
        cbTipoDeCajaOrigen.removeAllItems();
        for (TipoDeCaja tipoDeCaja : tipoDeCajaDAO.findAll()) {
            cbTipoDeCajaOrigen.addItem(tipoDeCaja);
            cbTipoDeCajaDestino.addItem(tipoDeCaja);
        }
    ...
    private void initComponents() {
        ...
        cbTipoDeCajaOrigen = new javax.swing.JComboBox();
        jLabel11 = new javax.swing.JLabel();
        cbTipoDeCajaDestino = new javax.swing.JComboBox();
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jPanel1.add(cbTipoDeCajaOrigen, gridBagConstraints);
        ...
        cbTipoDeCajaDestino.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Cuenta de tercero" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jPanel1.add(cbTipoDeCajaDestino, gridBagConstraints);
    ...
    public javax.swing.JComboBox cbTipoDeCajaDestino;
    public javax.swing.JComboBox cbTipoDeCajaOrigen;
