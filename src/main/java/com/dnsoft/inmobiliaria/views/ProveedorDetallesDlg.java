...
public class ProveedorDetallesDlg extends javax.swing.JDialog {
    ...
    void guardarCambios() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Proveedor registrado correctamente!", "Correcto", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
        } catch (Exception e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error al guardar datos: " + e, "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
