...
public final class PagoGastoInmuebleDialog extends javax.swing.JDialog {
    ...
    void pagaGastoInmuebleInquilino() {
        ...
        try {
            ...
            movimientoCaja.setDescripcion("Pago gasto inmueble " + gastoInmuebleInquilino.getInmueble() + ", Inquilino " + inquilino.toString());
            ...
            new ImprimeRecibo(movimientoCaja, inquilino.toString(), movimientoCaja.getDescripcion(), "", gastoInmuebleInquilino.getInmueble().toString()).imprimieReciboEntrada();
    ...
    void pagaGastoInmueblePropietario() {
        ...
        try {
            ...
            cajaDAO.save(movimientoCaja);
            JOptionPane.showMessageDialog(this, "Se registro el pago correctamente!", "Correcto", JOptionPane.INFORMATION_MESSAGE);
            new ImprimeRecibo(movimientoCaja, gastoInmueblePropietario.getPropietario().toString(), movimientoCaja.getDescripcion(), "", gastoInmueblePropietario.getInmueble().toString()).imprimieReciboEntrada();
