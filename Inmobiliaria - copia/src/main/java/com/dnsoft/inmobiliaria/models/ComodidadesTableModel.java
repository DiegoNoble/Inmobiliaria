...
public class ComodidadesTableModel extends AbstractTableModel {
    ...
    private List<Comodidad> list;

    public ComodidadesTableModel() {
        list = new LinkedList<Comodidad>();
    }

    public ComodidadesTableModel(List<Comodidad> list) {
        this.list = list;
    }
    ...
    public void agregar(Comodidad comodidades) {
    ...
    public void atualizar(int row, Comodidad comodidades) {
        list.set(row, comodidades);
        this.fireTableRowsUpdated(row, row);
    }

    public Comodidad getCliente(int row) {
        return list.get(row);
    }
