 ...
 * @author Diego Noble
 */
public final class CotizacionesDialog extends javax.swing.JDialog {
    ...
    public CotizacionesDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnDetallePesosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetallePesosActionPerformed
        ConsultaCotizacionDialog detalles = new ConsultaCotizacionDialog(null, true, Moneda.PESOS);
    ...
    private void btnDetalleDolaresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetalleDolaresActionPerformed
        ConsultaCotizacionDialog detalles = new ConsultaCotizacionDialog(null, true, Moneda.DOLARES);
        detalles.setVisible(true);
        detalles.toFront();
    ...
    private void btnDetalleUIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetalleUIActionPerformed
        ConsultaCotizacionDialog detalles = new ConsultaCotizacionDialog(null, true, Moneda.UNIDADES_INDEXADAS);
        detalles.setVisible(true);
        detalles.toFront();
    ...
    private void btnDetalleURActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetalleURActionPerformed
        ConsultaCotizacionDialog detalles = new ConsultaCotizacionDialog(null, true,Moneda.UNIDADES_REAJUSTABLES);
        detalles.setVisible(true);
        detalles.toFront();
