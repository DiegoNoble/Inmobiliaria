...
import com.dnsoft.inmobiliaria.utils.ImprimeReciboMovCaja;
        ...
        try {
            ...
            if (importePago.doubleValue() > 0.00) {
                ...
                if (resp != -1) {
                    ...
                    new ImprimeReciboMovCaja(movimientoCaja, propietario.toString(), txtDescripcion.getText()).imprimieReciboEntrada();
                }
            } else {
