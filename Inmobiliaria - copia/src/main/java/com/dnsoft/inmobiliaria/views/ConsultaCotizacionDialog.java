...
public final class ConsultaCotizacionDialog extends javax.swing.JDialog {
    ...
    public ConsultaCotizacionDialog(java.awt.Frame parent, boolean modal, Moneda moneda) {
        ...
        btnNuevaCotizacion.setVisible(false);
    ...
    void accionesBotones() {
        btnNuevaCotizacion.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                CotizacionesDialog nuevaCotizacion = new CotizacionesDialog(null, true);
    ...
    void buscarCotizaciones() {
        ...
        if (rbDolares.isSelected()) {
            listCotizacion.addAll(cotizacionDAO.findByMoneda(Moneda.DOLARES));
        }
        if (rbPesos.isSelected()) {
            listCotizacion.addAll(cotizacionDAO.findByMoneda(Moneda.PESOS));
        }
        if (rbUI.isSelected()) {
            listCotizacion.addAll(cotizacionDAO.findByMoneda(Moneda.UNIDADES_INDEXADAS));
        }
        if (rbUR.isSelected()) {
            listCotizacion.addAll(cotizacionDAO.findByMoneda(Moneda.UNIDADES_REAJUSTABLES));
        }
