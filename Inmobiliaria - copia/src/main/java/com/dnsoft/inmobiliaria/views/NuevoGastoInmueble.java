...
public class NuevoGastoInmueble extends javax.swing.JDialog {
    ...
    void gastoInmueblePropietarios() {
        ...
        for (PropietarioHasInmueble propietarioHasInmueble : propietarioHasPropiedad) {
            ...
            GastoInmueblePropietario gastoInmueblePropietario = new GastoInmueblePropietario();
            gastoInmueblePropietario.setDescripcion("Inmueble :" + inmuebleSeleccionado.toString() + " Detalle: " + txtDetalle.getText());
            ...
            movimientoCCPropietario.setDescipcion("Gasto Inmueble " + inmuebleSeleccionado + " Detalle: " + txtDetalle.getText());
    ...
    void gastoInmuebleInquilino() {
        ...
        gastoInmuebleInquilino.setDescripcion("Inmueble :" + inmuebleSeleccionado.toString() + " Detalle: " + txtDetalle.getText());
    ...
    void gastoInmuebleInmobiliaria() {
        ...
        GastoInmuebleInmobiliaria gastoInmueble = new GastoInmuebleInmobiliaria();
        gastoInmueble.setDescripcion("Inmueble :" + inmuebleSeleccionado.toString() + " Detalle: " + txtDetalle.getText());
        gastoInmueble.setFecha(new Date());
        gastoInmueble.setInmueble(inmuebleSeleccionado);
        gastoInmueble.setMoneda(monedaSeleccionada);
        gastoInmueble.setRubro(parametros.getRubroObrasMantenimiento());
        gastoInmueble.setValor(valor);
        gastoInmueble.setProveedor((Proveedor) cbProveedor.getSelectedItem());
        gastoInmuebleInmobiliariaDAO.save(gastoInmueble);
