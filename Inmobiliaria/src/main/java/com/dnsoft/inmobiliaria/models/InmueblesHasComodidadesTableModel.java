...
public class InmueblesHasComodidadesTableModel extends AbstractTableModel {
    ...
    private final String[] colunas = new String[]{"Nombre", "Cantidad"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case 0:
                return c.getComodidad().getNombre();
            case 1:
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case 0:
                c.setComodidad((Comodidades) aValue);
                break;
            case 1:
    ...
    public void agregarLista(List<InmuebleHasComodidades> comodidades) {
        list.addAll(comodidades);
