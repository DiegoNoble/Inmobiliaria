...
public class DetallesRecibo extends javax.swing.JDialog {
    ...
    public DetallesRecibo(java.awt.Frame parent, boolean modal, ConsultaContratosController controller, Recibos recibo) {
        super(parent, modal);
        initComponents();
    ...
    public DetallesRecibo(java.awt.Frame parent, boolean modal, ConsultaContratosController controller, Contrato contratoSeleccionado) {
        super(parent, modal);
        initComponents();
        applicationContext = new ClassPathXmlApplicationContext("applicationContext.xml");
        recibosDAO = applicationContext.getBean(IRecibosDAO.class);
    ...
    void detallesRecibo() {
        ...
        txtValor.setText(recibo.getValor().toString());
