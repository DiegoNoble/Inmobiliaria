...
import com.dnsoft.inmobiliaria.models.CiudadesTableModel;
 ...
 * @author Diego Noble
 */
public class DetalleCiudades extends javax.swing.JDialog {
    ...
    public DetalleCiudades(java.awt.Frame parent, boolean modal, Component frame) {
        super(parent, modal);
        initComponents();
    ...
    void configuraTbl() {
        ...
        listCiudades.addAll(ciudadesDAO.findAll());
    ...
    private void txtBuscaPropiedadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBuscaPropiedadActionPerformed
        ...
        listCiudades.clear();
        listCiudades.addAll(ciudadesDAO.findCiudades(txtBuscaPropiedad.getText()));
        tableModel.fireTableDataChanged();
