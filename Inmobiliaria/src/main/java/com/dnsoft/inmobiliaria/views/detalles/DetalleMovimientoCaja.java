 ...
 * @author Diego Noble
 */
public class DetalleMovimientoCaja extends javax.swing.JDialog {

    Caja movimientoDeCaja;
    ControlDeCajaView view;

    public DetalleMovimientoCaja(java.awt.Frame parent, boolean modal, Caja movimientoSeleccionado, ControlDeCajaView view) {
        super(parent, modal);
        initComponents();
    ...
    void muestraDetalles() {
        ...
        txtMoneda.setText(movimientoDeCaja.getMoneda().getNombre());
