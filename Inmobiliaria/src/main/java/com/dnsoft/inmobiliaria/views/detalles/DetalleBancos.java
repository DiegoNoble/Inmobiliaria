...
import com.dnsoft.inmobiliaria.models.BancosTableModel;
 ...
 * @author Diego Noble
 */
public class DetalleBancos extends javax.swing.JDialog {

    IBancosDAO bancosDAO;
    ApplicationContext applicationContext;
    Banco banco;
    List<Banco> listBancos;
    BancosTableModel tableModel;
    ListSelectionModel listModel;

    public DetalleBancos(java.awt.Frame parent, boolean modal, Component frame) {
        super(parent, modal);
        initComponents();
    ...
    void configuraTbl() {
        ...
        listBancos.addAll(bancosDAO.findAll());

        tableModel = new BancosTableModel(listBancos);
        ...
        tbl.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (keyCode == KeyEvent.VK_DOWN) {
                    if (tbl.getSelectedRow() == listBancos.size() - 1) {
                        if (!listBancos.get(tbl.getSelectedRow()).isNew()) {
                            banco = new Banco();
    ...
    void elminarSeleccionado() {
        try {
            Banco toDelete = tableModel.getCliente(tbl.getSelectedRow());
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Detalles de Bancos");
    ...
    private void txtBuscaPropiedadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBuscaPropiedadActionPerformed
        ...
        listBancos.clear();
        listBancos.addAll(bancosDAO.findBanco(txtBuscaPropiedad.getText()));
        tableModel.fireTableDataChanged();
