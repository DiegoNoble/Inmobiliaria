...
import com.dnsoft.inmobiliaria.models.ComodidadesTableModel;
import com.dnsoft.inmobiliaria.models.TipoInmuebleTableModel;
 ...
 * @author Diego Noble
 */
public class DetalleTipoInmueble extends javax.swing.JDialog {

    ITipoInmuebleDAO tipoInmuebleDAO;

    ApplicationContext applicationContext;
    TipoInmueble tipoInmueble;
    List<TipoInmueble> listTipoInmueble;
    TipoInmuebleTableModel tableModel;
    ListSelectionModel listModel;

    public DetalleTipoInmueble(java.awt.Frame parent, boolean modal, Component frame) {
        super(parent, modal);
        initComponents();
    ...
    void configuraTbl() {
        ...
        listTipoInmueble = new ArrayList<TipoInmueble>();
        listTipoInmueble.addAll(tipoInmuebleDAO.findAll());

        tableModel = new TipoInmuebleTableModel(listTipoInmueble);
        ...
        tableModel.addTableModelListener(new TableModelListener() {
            ...
            public void tableChanged(TableModelEvent tme) {
                if (tipoInmueble != null) {
                    if (tipoInmueble.getNombre() != null) {
        ...
        tbl.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (keyCode == KeyEvent.VK_DOWN) {
                    System.out.println("abajooo");
                    System.out.println(tbl.getSelectedRow());
                    System.out.println(listTipoInmueble.size());
                    if (tbl.getSelectedRow() == listTipoInmueble.size() - 1) {
                        if (!listTipoInmueble.get(tbl.getSelectedRow()).isNew()) {
                            tipoInmueble = new TipoInmueble();
                            tableModel.agregar(tipoInmueble);
                        }
                    }
                }
            }
    ...
    void elminarSeleccionado() {
        try {
            TipoInmueble toDelete = tableModel.getCliente(tbl.getSelectedRow());
            tipoInmuebleDAO.delete(toDelete);
            actualizaTbl();
            btnEliminar.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Registro de calles");
    ...
    private void txtBuscaPropiedadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBuscaPropiedadActionPerformed
        ...
        listTipoInmueble.clear();
        listTipoInmueble.addAll(tipoInmuebleDAO.findTipoInmueble(txtBuscaPropiedad.getText()));
        tableModel.fireTableDataChanged();
