...
import com.dnsoft.inmobiliaria.models.BarriosTableModel;
 ...
 * @author Diego Noble
 */
public class DetalleBarrios extends javax.swing.JDialog {

    IBarriosDAO barrioDAO;
    ApplicationContext applicationContext;
    Barrio barrio;
    List<Barrio> listBarrio;
    BarriosTableModel tableModel;
    ListSelectionModel listModel;

    public DetalleBarrios(java.awt.Frame parent, boolean modal, Component frame) {
        super(parent, modal);
        initComponents();
        applicationContext = applicationContext = new ClassPathXmlApplicationContext("applicationContext.xml");
        barrioDAO = applicationContext.getBean(IBarriosDAO.class);
    ...
    void configuraTbl() {
        ...
        listBarrio = new ArrayList<Barrio>();
        listBarrio.addAll(barrioDAO.findAll());

        tableModel = new BarriosTableModel(listBarrio);
        ...
        tbl.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (keyCode == KeyEvent.VK_DOWN) {
                    if (tbl.getSelectedRow() == listBarrio.size() - 1) {
                        if (!listBarrio.get(tbl.getSelectedRow()).isNew()) {
                            barrio = new Barrio();
                            tableModel.agregar(barrio);
                        }
                    }
                }
            }
    ...
    void elminarSeleccionado() {
        try {
            Barrio toDelete = tableModel.getCliente(tbl.getSelectedRow());
            barrioDAO.delete(toDelete);
            actualizaTbl();
            btnEliminar.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Detalles de Barrios");
    ...
    private void txtBuscaPropiedadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBuscaPropiedadActionPerformed
        ...
        listBarrio.clear();
        listBarrio.addAll(barrioDAO.findBarrios(txtBuscaPropiedad.getText()));
        tableModel.fireTableDataChanged();
